...
import { IdfilterPipe } from './SharedModule/idfilter.pipe';
...
@NgModule({
  declarations: [
    ...
    EmployeeDetailsComponent,RouteParameterComponent, EditCustomerComponent, AssignInitialPipe, FilterPipe,IdfilterPipe
